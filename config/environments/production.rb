Rails.application.configure do
  ...
  self.read_endpoints = ['fod-dev-redis-001.q8x6u8.0001.usw2.cache.amazonaws.com:6379',
  ...
  self.redis_read  = Redis.new host: self.read_endpoints.first.split(':')[0], port: self.read_endpoints.first.split(':')[1], db: 0, logger: Rails.logger
